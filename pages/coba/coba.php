...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="path/to/signature_pad.css">
...
<body class="hold-transition sidebar-collapse layout-top-nav">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">Aqram Allhidayatullah</a>
          </div>
        </div>
  ...
  <script>
    ...
    var signedInput = document.getElementById('signed');
    ...
    form.addEventListener('submit', function(e) {
      ...
      // Set the value of the hidden input field with the signature data
      signedInput.value = signatureData;

      // Now you can submit the form to your PHP script
      this.submit();
    });
  </script>
  <script>
